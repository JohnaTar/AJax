    ...
    $(function () {
        $("#rePassword").keyup(function () {
          if ($(this).val()==$('#password').val() ) {
            ...
            $('#verify').html("<span> hello</span>");



        } else {
              $('#verify').html("<span> hi</span>");
        }
    });
...
<!-- *********************************javascript***************************************** -->
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input  name="stwUsername" id="UserName" type="text" placeholder="Username" class="form-control input-md" required="" >
                    <span id="msg1"></span>
...
<!-- *********************************password from***************************************** -->
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="Password" name="stwPassword" type="password" placeholder="Password" class="form-control input-md" required="">
             ...
             <div class="form-group">
                ...
                <div class="col-md-4">
                    <input  id="rePassword" type="password" placeholder="Re-password" class="form-control input-md" required="">
                    <span id="verify"></span>
